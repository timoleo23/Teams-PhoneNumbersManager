...
function Get-CsVoiceUserList {
    ...
    process {
        ...
        else
        {
            if($ExpandLocation)
            {
                Microsoft.Teams.ConfigAPI.Cmdlets.internal\Search-CsUser  -Includedefaultproperty:$false -VoiceUserQuery:$true -Select "Objectid,EnterpriseVoiceEnabled,
                DisplayName,Location,LineUri,TenantID,UsageLocation,DataCenter,PSTNconnectivity,SipDomain" | 
                Select-Object -Property @{Name = 'Name' ; Expression = {$_.DisplayName}},
                @{Name = 'Id' ; Expression = {$_.Identity}},
                SipDomain,
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBq03i8kENsxAXa
# ZWuaqmmiJNT9Zaa0zDLPkrz3AoWCHaCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIF4GzkLoO4rQvzx2wSJW6auqpE8S
# t3a5TlGz3euMmp6TMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAJD9fZBD
# zTs7Rx3YrA8y4GF6DhUC2P/wU6VlcSCmLT1r9/V+sfwEpZ+EKjBN6SbqwufWhoQW
# wkrqLH68d+nOPJkytN28f2EU/+XePFySzQcXWO0n//s42baMIgzllLDPt4fA8XL1
# sHAW2LqYIQFVLv4ckto31BjEMBa9NCeei5XJcUQCLf4CSjeQQRUsuaDRC04nVb+h
# pBLmnkc90p9hOPs64FuMJjqZa04DMTm0T1kyYEuY7XJFNMCm6ocQg6KfZO/S4FD+
# c/ol01DlTeaOKOA/PLS+Nt3wTmTjkYsPQkNIN7Sso26Prlzq7bzw1hvTmGSMLXtJ
# Al3/c0hesMbA0qyhghcZMIIXFQYKKwYBBAGCNwMDATGCFwUwghcBBgkqhkiG9w0B
# BwKgghbyMIIW7gIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBWQYLKoZIhvcNAQkQAQSg
# ggFIBIIBRDCCAUACAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQg36CU
# 4iwrx/owC6PZqpZYcT4ruwRi18FjKyl+J4ddiMMCBmGVXaQyWBgTMjAyMTExMzAw
# NjQ5MzYuMDA1WjAEgAIB9KCB2KSB1TCB0jELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# 9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgF3FhHbzfwVyicFFZ3FUKYoEMFg+6BaK4
# yIHhp8dbesAwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCAamYjgsiwIVMaJ
...
# FnTFxh/0BIjnlI3L73eKm+9/zh1TMA0GCSqGSIb3DQEBCwUABIICAHV/ntLEGZ1F
# YfdC3zTEJbXYKgKYWkCLRweyFc94W2aXnF4NSt76E0rZY5e4Wxz/aFfeRzPRGd+m
# +oG0dZAhJmuxA6iIyYjhI9c+FGMjmL0yiW6aqDJR1uK1/hTPBMWjws67v7XEO2vm
# C4ZK7EMMEiAgHKA0+pRsCOAZdZYfpw86cfd0HltFPe1dAOwXz+8t1ThLT8UlLBlu
# 0saUZV6Q6F+ytf02W1V8mvBoDC9MGMVnM4yTBjxmDJjSROejd9oRmHFE6iDaKK2y
# HPWQZP32OiDu5bfGHyZHjjC+X4rIx+blkXTLJhdr9yere9N8NPFL5LLF5/92oCw+
# G09rAzKdvD9si9Uov5g0d9zBN24qMM86NnEWpeFN++Uu9Du89jOQ6fOr0tLmBfzy
# adZWRByRUPLR7vBhgDuCuMUsRbOwA5RekXjLk6pYHLDGPh42DqPsWyYWK8+C69QO
# gCqw95n9MYEkcyFgCeqvDOmcAKZEImF2/TJDvA8zgUZv8VRSdEA9jnVdCuNxteqr
# EGkc+WOn3TB+Hb2gpSAbJO1msXrooBQoqnwfYGv9YoVnWhoIBWC2Ra8nPeCZczhe
# qQ0iC/wpbvzJyDYY5K8oleJ3klP3RwfMoWat7+je2ZdKBV/5X9F/Cgwe8aoohXeu
# KIywFkPjGikOdl717A+6iKZdtBzUUKoZ
