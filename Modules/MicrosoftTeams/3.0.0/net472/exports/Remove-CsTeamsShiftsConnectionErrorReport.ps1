...
<#
.Synopsis
With provided filter criteria, e.g.
connector instance ID, team ID, etc., only the corresponding subset of report instances would be marked as resolved.
.Description
With provided filter criteria, e.g.
connector instance ID, team ID, etc., only the corresponding subset of report instances would be marked as resolved.
.Example
...
.Link
https://docs.microsoft.com/en-us/powershell/module/teams/remove-csteamsshiftsconnectionerrorreport
#>
function Remove-CsTeamsShiftsConnectionErrorReport {
...
begin {
    try {
        ...
        $mapping = @{
            Remove = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Remove-CsTeamsShiftsConnectionErrorReport_Remove';
            Remove1 = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Remove-CsTeamsShiftsConnectionErrorReport_Remove1';
            RemoveViaIdentity = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Remove-CsTeamsShiftsConnectionErrorReport_RemoveViaIdentity';
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDVSMHTro4RkvaR
# gO/h8otZmXeNk3crNHibumXQ1fG49KCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJsrTlLgtt1IvqVkFPgCmdKm+gWM
# Z7xOjbY4LjjBFFRVMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAIG46FSo
# MTkhASU8q6iLwmI6Tk5lVchi5zm1kyIndh/4mYycT82rHAD+wnXymzPPOfaC+tDN
# M8LErMHtiM5AaH0+HrRuMm/yJdRH2qUemLsP1kf//FeMpIgx8LtvAXSJf1ZlSZdz
# eEDR2ND1w31KzDRvUpSWZJm9it6fi0CQ5heJJTgpOoBEO5VOK9aiuW1F8PR4dk6c
# 1mw6r/DKk8fakuHp9dchZKgDCjwYC9582Qr6xONz0e+eMmomUSs//LGMPoBknpV1
# uH8sE7MP4exu0Be8VnWSmT/R5XlZ7oF/w5/6+i2LeAgM4gSA7pRU9Te3UbrUDMDf
# 5rMdNCpybivqTSqhghLiMIIS3gYKKwYBBAGCNwMDATGCEs4wghLKBgkqhkiG9w0B
# BwKgghK7MIIStwIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUQYLKoZIhvcNAQkQAQSg
# ggFABIIBPDCCATgCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgIhqn
# LyjwhUpgiIhDwBbqbCmdFkDe+L7ITd/+1QB5oDcCBmGS4WVnkhgTMjAyMTExMzAw
# NjQ5MjguMDE2WjAEgAIB9KCB0KSBzTCByjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# MC8GCSqGSIb3DQEJBDEiBCCz9ehQMQsTmS40cQDinONMzo0HaUs18yP9M3ROh5UQ
# cDCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIJPuXMejiyVQjF8QanwtdA2K
...
# 0xroNLSRIvtQM0E0dlowDQYJKoZIhvcNAQELBQAEggEAFCCOkCpxq4J5Ug/9llOc
# C0pjAivioPmV2h1alLatpF648N31YH193bfBX3O7VoG6hXBf7kMNEAlofqXT+rZj
# WCgf5bjFjxavImw3bNOL7lGwdARL4V8MCcKlMLjOJtwFeiOGvjGKKViPK/xBBdAx
# n/VMlfDKa++EpVI1WGREuRuBeFLhKZLN1TyNdPJRIvqSIckicHqZi2k5j7cJcxYu
# kPzlqqBC1CvnsW8VeFRiOJYhXVHNuO6jvzyDAKLWmMutGf4D4++VsP91Ybo1EDmW
# wbQd5bnLsVr0jt+pQOSrRFPmFlpdPp3BVBN7VmtUf8LQA71mcOZmbeiSjS1USJjJ
# vA==
