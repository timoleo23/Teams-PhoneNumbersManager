    ...
    process {
        ...
        if ($Instance.CallFlows -ne $null) {
            ...
            foreach($callFlow in $Instance.CallFlows) {
                $callFlows += $callFlow.ParseToAutoGeneratedModel()
            }
        ...
        if ($Instance.CallHandlingAssociations -ne $null) {
            ...
            foreach($callHandlingAssociation in $Instance.CallHandlingAssociations) {
                $callHandlingAssociations += $callHandlingAssociation.ParseToAutoGeneratedModel()
            }
        ...
        # TODO: Add Schedule after the data model is ready
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAjOoPfu3AxJD2R
# V2UvnJVcQqcl4zxxWVUXaTOm+mcrfaCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIAfa+WgbSQOgsDCmSNdXBke9/mKv
# dXuUCa7ayPxy8YCGMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAI2FrWhc
# 4c0q4VVa2Cpf5+oeRMzRfTrhBp5XpqiItxuq6q/YO2BHtEv/DE4xJ3/nqRswH+nQ
# /eKDtlU8s1c+TePZ9Y1Jp28LLKEQyZeGsDiPXDP90GDw+ezGR+5gus/bjhhxmrL8
# o4vwbSFe0b7NDJRnvKA/dFSsFrewQVD4N+evSFARxO1fvT2CrE0suEl9JcOLxIby
# RcsmgbUXo7JHm4YuHh0B93yPAz5Ex98XQJzKcrG0j+HXnXnFlBqdfoj2ySIRlchz
# 8Kg8mN79yeBR6FaRWbTZxNZDgbdQQWWL46DCSv6ZaP5lsgpEh9dXrcZn06Gdazom
# O9kdM3uwOToqPXehghcZMIIXFQYKKwYBBAGCNwMDATGCFwUwghcBBgkqhkiG9w0B
# BwKgghbyMIIW7gIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBWQYLKoZIhvcNAQkQAQSg
# ggFIBIIBRDCCAUACAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgD2wg
# sYJC+X3CRj5ihorN6Io7x1IOAeFmfqvnjYw6rOgCBmGVXaQyixgTMjAyMTExMzAw
# NjQ5MzYuNjYxWjAEgAIB9KCB2KSB1TCB0jELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# 9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQg+PXbj5eT0wCbGgWhzQDXZkX7bwzw2fKu
# tkGBctH3wCgwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCAamYjgsiwIVMaJ
...
# FnTFxh/0BIjnlI3L73eKm+9/zh1TMA0GCSqGSIb3DQEBCwUABIICAAGI2S2bshxD
# +EgkVUmkgUQCFVxXy6AAh3mPVfAqpy3K1sezDuJCSCVDYQoRMIpb7a8hv2NAPQ40
# ie4v0Ub2MYwbnX+pZP9peTmZeTRjPIEI+sR0oqupWRhQQeB2kaassTrb+B5DIp6p
# Nzdn9yWauwwwmQPUxndwlKr+4cJEAeBwOR+MOFHYP7oaqfM73/SZK9CPfLNeVQeI
# FPj1BJIt6bfV1fkigkBqAm5P94esu6z6EXxV/2hNYpvwpsGSIZamyWux25dcw4qi
# LR71/Zwb0rz315mX8EKJvHopJ8HrYqUr9R4xdNG2k1hDKd8EOoYnyAvsT328Lljk
# vdJ147n3O9nkxs3FjwFAIOZ3y/OGE1QMSJAqBvUU8h+dxzEK1ESYgqM6P0yD9MKW
# /OPRhnEiSRtj0PraJrYQhmNSoO4Tcxvt3QaWyPgTp0iUvE7Xt0Q5LtYYJgJXDHLi
# paQHPelSaAWnqqYtLtLuI0GSWjUutedFv+sKiF1zuBiVxSmmA/1S3R2w7Gv//x+H
# y0LgxKOv34I5ENE/Cb++T4loAxPGZtuUryU/E93HZhnGarX4RXyrL6IYJZ5/8yzQ
# jwKbMrJj16HVzSXcPCNhkDwI4+FLq9gUvyAKyZ+r1+9sx0+1qAhsBdRtida3i5hr
# uLNfjVmBIQtBOtG6qiFdy5aI3PfvZKCY
