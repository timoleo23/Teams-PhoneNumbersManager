...
<#
.Synopsis
Enqueues the clear schedule message
.Description
Enqueues the clear schedule message
.Example
PS C:\> {{ Add code here }}
...
BODY <IClearScheduleRequest>: The clear schedule request.
  [ClearSchedulingGroup <Boolean?>]: Gets or sets a value indicating whether [clear scheduling group].
  [DateRangeEndDate <DateTime?>]: 
  [DateRangeStartDate <DateTime?>]: 
  [DesignatedActorId <String>]: 
  [EntityType <String[]>]: Gets or sets the entity types.
  [TeamId <String>]: Gets or sets the team identifier.
  [TimeZone <String>]: Gets the time zone.
.Link
https://docs.microsoft.com/en-us/powershell/module/teams/remove-csteamsshiftsschedulerecord
#>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDfYdwWNSiWGq6j
# ujpxXRN10S2m/eeYkUa5Yidc1iFwsaCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIN/SoA/+n9hLZzi4LCkDksdBsjqz
# Ki4yAqEhKpkh7osiMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBACQc+Uwm
# aO5vBjTENTX6zCajznnb3ZBirosk2EVkMJR70CLV0SdzfwgHR23CYcM+WWVhCvfv
# vlSzFcXfccZF8kOfGxdFW1svwkWZ1ltuoiB9c876G4adD9DHWPx5sQH4Pl54YZXn
# fbp5urnhEwrq5eJ2d/hf0enyewkaysT/L63H+ykVYX429i0/iMc1/YxXZmxDnxC3
# s6sBtzFyn4TknyzfFPl67Bg4YtMdraZiufB+meChqF5k1hLwup9Gsm4IHUv8p13i
# tr1NHArHoy1BzpFlJmuLE/r1sNfqUwj9v45s2kKR/9fAhlENdZr4UX6IibVhwvuG
# iwTld4aZRhxaqT2hghcZMIIXFQYKKwYBBAGCNwMDATGCFwUwghcBBgkqhkiG9w0B
# BwKgghbyMIIW7gIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBWQYLKoZIhvcNAQkQAQSg
# ggFIBIIBRDCCAUACAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgMY9u
# HAI0WZLHy0N5AzXROO1MyukP0+jSoXeB/cj2FC4CBmGVXaQyJBgTMjAyMTExMzAw
# NjQ5MzUuMzMzWjAEgAIB9KCB2KSB1TCB0jELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# 9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgQzQMfYQ9A7kIik/NWwg5ITqLWtBfG+N6
# T9ulQJU4VT8wgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCAamYjgsiwIVMaJ
...
# FnTFxh/0BIjnlI3L73eKm+9/zh1TMA0GCSqGSIb3DQEBCwUABIICAJ4dfC4CR2K+
# kuM513/XFILIIGEoNI8H5kkBxU768nQJOAUQMIebWuASKlUsvje84TlqSbETEcUr
# dXLWcOcrR8TNIZ2br336KsvrMo5PjQ0to6T4LvAlFPdQkbAn5Q2f/KZd2A8/p8yl
# L4ZPnZSMyrr9zYagv/YrxV3l7UXE3bgO8uiUAiJfq60I3L283UZcfD3kxx8mAxlq
# zpYh/q+FFYtlbA9a9DS88pdBn1AA2QS1r9lMWtBxoHKn1Y17NP7x0k6oeF9Qn3UX
# 2rfI5mCwu/K8tDIzuRKQVlklRGTIy6GUJYR8rIs8vfOER3hAjc4bHQnvxhsADLRg
# NRgKxsi2ljghfxWNOjdDs+Hw5tuQ1mAWbaVoPIF4mqYvJGzx84p2hmxKsfeYcsu5
# wWcnJBRsZoEciGDFsoGar5W6fM6zlR31jQ0RtCzfSCU/F3p2Gjz7lu0lpQ7ViF/G
# rg3ZpokfyHGwm9aL38HZWUr0krCiuMeY8TNh+YGJHBACkPjIHzKdCu5qqqhFNTi+
# Ci+NsOeBkh9gaDK6yXNdyiXpd0m5hKGOL9Frw7T4TfzVCNb496RTFz6yCEMfxI+B
# du+OQIxLZ6o4rDcZBYegvzMpa+tZjaWnpNwFipP+no5cyJxuzpTOYH9cOgPyiO2Q
# RnvJr+BismJ2H0rs/1wHj68PfCmITMGd
