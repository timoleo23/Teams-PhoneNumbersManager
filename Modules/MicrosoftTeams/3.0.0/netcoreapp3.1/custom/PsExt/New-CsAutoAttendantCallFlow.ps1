    ...
    process {
        if ($Greetings -ne $null) {
            ...
            foreach($greeting in $Greetings) {
                $inputGreetings += $greeting.ParseToAutoGeneratedModel()
            }
        ...
        if ($Menu -ne $null) {
            ...
            foreach($menuPrompt in $Menu.Prompts) {
                $inputMenuPrompts += $menuPrompt.ParseToAutoGeneratedModel()
            }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCEqbhUCnMyAs+l
# YZS8f8cTOyG9Xiro3chSJiRyyRPPQaCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIDwAtNIewDgdLGz8UPceGlAxyJ2a
# NYDHNQ/6m4DqQolkMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAFiPE4Qy
# ChA7SmhjfT4Zprk92FxKcWBb6wNZe4XIT8KFDuhG0Qs5wwCfe2Ul3gAp9YHzdIbt
# aQVGpzOdBy7eSIsgRRjjWnDGS2p8gPgWplWPgOOoadvuO3IfW3jIATGVFq/9wO4z
# FwgVwnj7CrbSojQ85nKQesaL4RmBBR+2LChKboCLLBx+BkvENAo1Mw5mjf7u0Rp7
# d+K183XteW4GiAVvRCvTbLzGVne9aWPxtxrO4BDVGv0Jj3FQPfNmowvAKXs2+Zym
# 501synuIyfn0mcyqG3whL9VP5IGQ6uIO6qBzJoYWhgXR8sFu1A5ZdJixeCxH4HHm
# mdXIp2UBQFhuJPyhghcZMIIXFQYKKwYBBAGCNwMDATGCFwUwghcBBgkqhkiG9w0B
# BwKgghbyMIIW7gIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBWQYLKoZIhvcNAQkQAQSg
# ggFIBIIBRDCCAUACAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgg3mo
# b531XXb1oS6fRe8TdXIzfIoDbxdF2u9+0WGzYn0CBmGVXaQxPRgTMjAyMTExMzAw
# NjQ5MzIuMjY0WjAEgAIB9KCB2KSB1TCB0jELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# 9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgUZC1p13jOWBBuui14/WkYv7+ZnHSd9fK
# nG27BcPpx0EwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCAamYjgsiwIVMaJ
...
# FnTFxh/0BIjnlI3L73eKm+9/zh1TMA0GCSqGSIb3DQEBCwUABIICALbwtOxH+JFD
# HR2nnB4aMpDdIAPfCnc/9sKDLUf0FMHQ7KsVFs7Vn5UkGI+Lf7Lvow0UA3cMz1Ol
# cG2nBscOFfHDZYMcS/tkBfAKdQG4mCoWvGNeJ+BuTH9t5B6VtpVqtSxaJKnAr96U
# 4JINn9BWrPT6cHjgdzPR3Zv7tfM4XbEOPrlb9M+hV1NUnBZ3C0DbCqsKtAUT/rkd
# 5/S/mkXZeA92FKyHWLHCOTAY778lgbpMXIX8Z+XEcQYxNlDNLqH0VMDeOyMSslVX
# /njBp7f6iL2LWAOznBTebrOK3v8/UmnsEF7Ld2vff6Eh7+PDBgnDUxkAGD1ww99/
# 5r6dT8Sqax/ZC166VTI/J92334MlAAVry7z7Npf3cusFXI43xpw2Lttfrb8VCSJR
# YowfAIzRPR5sg/7nX+64wRjc2/GA20rT01yJT0vuqd4wa38DGgY2bPnYr+jaRC8X
# tDFeeddRnoBknZ7n4H5bSUNIlVTdKjvjYhHopwlUpZPfjEKk5VcK3QCzKx8cGuyP
# cbd51kcSTvyFAjXsDTq/SBE08ad91R+XOtRAVPhX1bdO0MAYkkNAjxKkKhgc4Tht
# fM3R9QsE5hZI/zUffRvZj2Eha6Tpx5N06eiujXYXqSikd9IA9ZsPEkprlQCsQsFe
# X10RjXlAojzX4CFR+tF1mqnjjPSpEdzr
