...
function New-CsCallQueueModern {
    ...
    process {
        ...
        if ($Users -ne $null -and $Users.Length -gt 0) {
            ...
            $PSBoundParameters.Remove('Users') | Out-Null
        }

        if ($DistributionLists -ne $null -and $DistributionLists.Length -gt 0) {
            $PSBoundParameters.Add('DistributionList', $DistributionLists)
            $PSBoundParameters.Remove('DistributionLists') | Out-Null
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAY5Rl1pfkmQCss
# sY28M8ipedf+DweltzZyUa/YlbhvpaCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJdAmI92FQRo0Lbat/e92rdacmJF
# L1wRuCxWDKvUZUZwMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAFTTUi0g
# 60K/inYCJXX4ruxWx60fDkWhmKbt4FpKRsAhITcqQo7E/HaZpz0EvRDMyGVkEAwl
# S0laXHh+GbbgcLH6V9kbw14R4BgiWgDKfsRph612I8cwXi774WfIsqo0vBu8sQlw
# zIUrx1QnwqZzGwCp2LlpSRdnN+LYkVP/HE8e3L//Temds/PdY3oyUfEGblng1D6P
# J0AFLpiuukhvG97VXo/lwVxg4pMX61vj4sjIwbeTY9y0T4zv/Wk8BnZLdo7w5Fn/
# HSBy5tnL39Yef06EmGVBelSoVLzLFTCLhFWXQ4VPEBeHuREUGl0sxBUk4fkctARK
# PZI13HqPydM8uzmhghcZMIIXFQYKKwYBBAGCNwMDATGCFwUwghcBBgkqhkiG9w0B
# BwKgghbyMIIW7gIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBWQYLKoZIhvcNAQkQAQSg
# ggFIBIIBRDCCAUACAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgwhPQ
# c38iMa0w+vAwTokpNGS+rAqZiwOt6h1IY8I5+T4CBmGVXfZEEBgTMjAyMTExMzAw
# NjQ5MzEuNjY3WjAEgAIB9KCB2KSB1TCB0jELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# 9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgJm9EAOUmNGv2QJFMFuSWXch9PAtIjJlC
# 4CW/SvZMAoowgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCD0veCrdd9Kvn7z
...
# VFpeZth1IolYcPj8Oie0+ggsEzoZMA0GCSqGSIb3DQEBCwUABIICAGWaKjaFwuv9
# mMyMnzjzdWPxm1vecQ/Uu/VWDpSYFcyy0O5fJdxbQg9T9Quv1QZz3Gnd/0ghoOYj
# z1glcpcdzJCrwdXXAeoNn0kqluT+de/meDQTIpzhkM4HDqOnYO4is5OkhPppuLax
# H1tmAKhlN1ERaz7RLhbDeRNuCheCUx8a3FEHSziU0XMDj6aDTOQAFHl819wJpJ0S
# Uy2/S8MAePBir7DN74RZSCil/n85ULbUmAuLd5Oyqqi4tZLDm8MzHLt1ncD9r2wC
# FfCaEluBUcAjGUywdeFb4jSTomUwkvKOm2O34WAo9XTnwOudBoxAv9CPfrx9BY3i
# YMK2Sw13waFmdQ3s9vbyK3s6eGXmLCrjShWvBPeYvOUwWvpWzDHBlmpz2/dH4FTZ
# U3bmwlsKt2EMfhc1uUA5Y2pA1gSnjoDxnmncYOw1afzwp6b3qN7tnSLsybqObyeD
# DnEQghKAWNCGVLXjL1FQb81NHX5Km5XFqgfgnhmFyGL6HspTAkMIYdVRp3gt+Iux
# 6iWBZpSOtEZ9NWatv7JgSCKW3JfUNe3FKybf/8w5wzPq4VhwUncifuFUp4VU0Kza
# HPW/iSMU2+LyhSu3hHydJUVPhjl3+ENoWyogkpaKvInHX9WMgQxTu8vI0HOe0Au5
# v3NpjJaS8DsG+mutx7pO2w5bu+V2ssUL
