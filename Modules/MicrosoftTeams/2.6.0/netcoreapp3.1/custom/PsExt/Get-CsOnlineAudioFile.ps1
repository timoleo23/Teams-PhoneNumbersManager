...
function Get-CsOnlineAudioFile {
    ...
    process {
        # Default Application ID to TenantGlobal
        if ($ApplicationId -eq "") {
            $ApplicationId = "TenantGlobal"
        }

        if ($Identity -ne "") {
            $internalOutput = Microsoft.Teams.ConfigAPI.Cmdlets.internal\Get-CsOnlineAudioFile -AudioFileId $Identity -AppId $ApplicationId
            $output = [Microsoft.Rtc.Management.Hosted.Online.Models.AudioFile]::new()
            $output.ParseFrom($internalOutput)
        }
        else {
            $internalOutputs = Microsoft.Teams.ConfigAPI.Cmdlets.internal\Get-CsOnlineAudioFile -AppId $ApplicationId
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD4C/XOGGu7YuYN
# cOG2Y6M5n1B9GmxY/KO0TBDv3UC35qCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIBliGfvUkU6y2rtOZLcL4Vr4GV+t
# fme5aALW9ith4vIZMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAIavpsfS
# oMmT/DRYakzkNenbH5PgL5uNUkFJbR52TH31ihUQsSeyRxfZKVmCSVDfSmdpXStU
# QzFOuuQ6uECDdIK0CDo+W9FnxW06KVqw44K7fudw/Lkdy9cKPOs/MvZHZQETlxt5
# QlV9NTQxhE7BxDR70+KvFiLFZKIrN5XgpFGEg4tf7YdrANH5PacYTUI+yV7/S/XB
# zCn3XmhnCrQqNkN5+sediOOc7CsjzMzheZrpWNNfqEMyr71XPODBkSZRcv56jXAI
# 9MNhpJE5e2WAyU4gqpoJw4VQzdolWhW4+wyVVFasK0BcOY72wtgEopdd3gTHH2Eh
# cbPMzk3by0cT6/GhghL7MIIS9wYKKwYBBAGCNwMDATGCEucwghLjBgkqhkiG9w0B
# BwKgghLUMIIS0AIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBWQYLKoZIhvcNAQkQAQSg
# ggFIBIIBRDCCAUACAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQg33+W
# ieQO/utj6gLctdPfSgzndWeI/r6yZ+TRiSFiX+0CBmFIuH/bdhgTMjAyMTA5MzAx
# NjMzMDIuODQ3WjAEgAIB9KCB2KSB1TCB0jELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# CSqGSIb3DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgPRnRH3Kl
# 73qZaTkZrQpfSBQMn5vlX47ho/YkvYYlNPowgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
# DQEBCwUABIIBAHhHh0SHTtCrOVmUb60n8d/X7gOyKjuVTsK6YdXKQyBdRSFQKQOu
# P9tR/RpbI/kIdvMLxwWtXwLUHx4FnkcZ7Xx0ihN0L5bxFL8g2fqLdF6mw8Dhp0se
# GKc3hWh82gq0t4xIfQ/0hTBcbOwU4q3aKZ+yjIaQQEaxRk/kvtH05QhxzwTHDGb7
# rHwqmxYZBb74QCyW+FYSE0E9hwAwR1dq7qkUlaNaYuUqmQ/ESuT8RbRASrdSHscJ
# LGj0A4GDN6j3PTCPcdq/th5IsNDPjoI7kKISjb8rDBjXBe2QvYmQHsfhvnqLcL4a
# O3N1c5QwZjytm0GnD2LlwScX98PjM2LZ5QM=
