...
.Link
https://docs.microsoft.com/en-us/powershell/module/teams/update-csuserroutingsettinguserroutingsetting
#>
function Update-CsUserRoutingSettingUserRoutingSetting {
...
param(
    ...
    [AllowEmptyCollection()]
    [Microsoft.Teams.ConfigAPI.Cmdlets.Generated.Category('Body')]
    [Microsoft.Teams.ConfigAPI.Cmdlets.Generated.Models.IDelegationDetail[]]
    # .
...
begin {
    try {
        ...
        $mapping = @{
            Update = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Update-CsUserRoutingSettingUserRoutingSetting_Update';
            UpdateExpanded = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Update-CsUserRoutingSettingUserRoutingSetting_UpdateExpanded';
            UpdateViaIdentity = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Update-CsUserRoutingSettingUserRoutingSetting_UpdateViaIdentity';
            UpdateViaIdentityExpanded = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Update-CsUserRoutingSettingUserRoutingSetting_UpdateViaIdentityExpanded';
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAj9SWA9V9a7C14
# mDfcLuJeJ9X82SwSJpiGISJ9hFnQ4KCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHCRVHboqGGwLAcygseCfapSOWdP
# qG5JBfe0el0IngmaMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAG2ylNYv
# snuxYEXJn0TQ6X4UjatpziiDD5DPGOF/CwgmeUJ3UvYRiwgryUZl9jVqTA98IAqs
# rTZpY0lfSho/cy6e7bPyHe6SJSlUWmsndcPm1Y5TXDkCoOfZb7+Pl761dsSZ+qMS
# wxPe0eObiy7pUh/cq+QODD+8zz4Yq3la+DOHdEdiMIOZR5WiVMIimG+WcvP04gvH
# KtIEIFJMJMZ9bDcWmKsSWXY9Rn2olsKcGHjK9QFO8SmmGifxSBNXDsrjCI+qd81s
# wizq0Qk8eQHxNz6NS5PvEI75hoZBodwIHT+imLsMQGwC/0dXUdXV9cpDSi3iBt8f
# EuuNrROhy1sY9U2hghLlMIIS4QYKKwYBBAGCNwMDATGCEtEwghLNBgkqhkiG9w0B
# BwKgghK+MIISugIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUQYLKoZIhvcNAQkQAQSg
# ggFABIIBPDCCATgCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgawli
# i36JARC+5rZMyycPoehkO5I5dhNbAFCCCUOdXfUCBmFDm+TbIRgTMjAyMTA5MzAx
# NjMyNTguNzY4WjAEgAIB9KCB0KSBzTCByjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# CSqGSIb3DQEBBQUAAgUA5P/mWTAiGA8yMDIxMDkzMDE1MzEzN1oYDzIwMjExMDAx
# MTUzMTM3WjB3MD0GCisGAQQBhFkKBAExLzAtMAoCBQDk/+ZZAgEAMAoCAQACAgXf
# AgH/MAcCAQACAhFiMAoCBQDlATfZAgEAMDYGCisGAQQBhFkKBAIxKDAmMAwGCisG
# AQQBhFkKAwKgCjAIAgEAAgMHoSChCjAIAgEAAgMBhqAwDQYJKoZIhvcNAQEFBQAD
# gYEAPoUybHIjL/9MtrJqSs+cDZvRkrn6DCD3zrsRrSUUlFhVBBZGIRkVG/sQFE2D
# RbuLGMCarx36R0lNkrByumE62oucOP0AT5n6wdIrdF7f4UVRjgIUl++2oKTRnn+n
# 3ttypK6/n7IOtUmU/f5owSwbYwlYfgML2TVgm/CXUfv1PO4xggMNMIIDCQIBATCB
...
# EAEEMC8GCSqGSIb3DQEJBDEiBCBALYK6dXF+vOabS9U8IbP5nKforRyIFfaUZDFy
# GYJB5zCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIHvbPBIDlM+6BsiJk7/Y
# fWGuKwBUi3DMOxxvRaqKGOmFMIGYMIGApH4wfDELMAkGA1UEBhMCVVMxEzARBgNV
# BAgTCldhc2hpbmd0b24xEDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jv
# c29mdCBDb3Jwb3JhdGlvbjEmMCQGA1UEAxMdTWljcm9zb2Z0IFRpbWUtU3RhbXAg
# UENBIDIwMTACEzMAAAFHnY/x5t4xg1kAAAAAAUcwIgQg2gkmd75x15lwyxLVBhRN
# 7PSji08tv+HnccrRrkutj9owDQYJKoZIhvcNAQELBQAEggEAjNt5m/QF7FW3A/Np
# xxnhs0UdVQWwzBKPVdcbv8nJ2j7EXWVuyMcOidQdNkaa9EYqPx8PfPLG+Qig3XAF
# YOnlj1MTCGXSXTwpyud0zB+pyp+YDEBe/K8m2eaRQHXmd1rbl1D1aUaGxVF7RnlH
# SguSsI4Rga9h9JAbctKfrVFxjeXlFYs/0ND5Kw+bOfv/iiHkoeiuN5KmHA1kkk3W
# TFQdSBsBLCFtdjYEmwXZRJ7yBx6fFV92YE2QpWfZ+zbX1ZyGhBhuw/BkeEDC2n+8
# NmVtHadAt3KvGgsWIOtDeJ4zw9yQJvnZgXpwlpWVvlhPsVMfA5jN4kZGg7qBL0Fc
# yjNoZw==
