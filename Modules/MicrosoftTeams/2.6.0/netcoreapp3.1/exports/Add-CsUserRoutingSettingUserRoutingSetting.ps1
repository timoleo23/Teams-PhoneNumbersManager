...
.Link
https://docs.microsoft.com/en-us/powershell/module/teams/add-csuserroutingsettinguserroutingsetting
#>
function Add-CsUserRoutingSettingUserRoutingSetting {
...
begin {
    try {
        ...
        $mapping = @{
            Add = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Add-CsUserRoutingSettingUserRoutingSetting_Add';
            AddExpanded = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Add-CsUserRoutingSettingUserRoutingSetting_AddExpanded';
            AddViaIdentity = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Add-CsUserRoutingSettingUserRoutingSetting_AddViaIdentity';
            AddViaIdentityExpanded = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Add-CsUserRoutingSettingUserRoutingSetting_AddViaIdentityExpanded';
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA6j/GS/VZo2uHU
# Z2RoDAaGJuKFIMan5s8ZSWHkwlVeVKCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIJHUrkisS/I3q8xOtM3X29r9N9eS
# Zi5fmJXnIxo7jJAsMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBADG14PIp
# d2vOM0pUXqYVWZS15ocHTBXM6ZnzUdkwJeKX4MZFx0VwiNqbgL/a3t1XWo6J9q44
# NKIllln+ZEPFB86yH+uxJgbBKjl2Q6Y5I9xYYR9Ci/NeHD7UBDpsPWzlvRyolXgK
# TvNaIcIehxSFErTGgRllqutuCl2sHB8qC0HI6Bv6o92JtlhB7voygBXLRtaJNihN
# WAUc4kX74SwUA06byMaVlWWylcLwhi/31OU0TajheR9Sr8cSXqvoQJpL7QVwSych
# vzVPhp+u2jq/4+LHDrtwmCWaNZ0DBKEbAX1vzSo4keeIVVzEA4/kbU6kkCojjHkA
# Y0VQ9GP6DyvsUBihghLxMIIS7QYKKwYBBAGCNwMDATGCEt0wghLZBgkqhkiG9w0B
# BwKgghLKMIISxgIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBVQYLKoZIhvcNAQkQAQSg
# ggFEBIIBQDCCATwCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgYASU
# lpoTNa1oTlINFJI3ul6woFfJWKn5BTSinpw5vncCBmFExLMXRBgTMjAyMTA5MzAx
# NjMzMDAuMzA4WjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# MQ0GCyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCC0m0LoFAgzdxwTs2aQG2sZ
# yu5Sa3Z9y449AKNIAHL2ejCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIJxZ
...
# V2N7aGrOTVESAgdFVxWsEvSTkixwO1EcqpGEjKh6ksxfGYFDtau/PIs3vlDJNgFd
# iZDHdZWRqhR9mNHfJvepI9H4k0IWrLqbhGD7PYxpAMeYxXejIT3LF9jFrem7D+bm
# IflH3y8YHUyd48YscdbTk73SbuqzKTKwkAJ2u18H60j3jbNWNZk54nWifTrllxuk
# /ywmFIvM9tPeYXylzUwEmCrvbkCHPipvyuZawPGrV+cFdzy5zFctpL1OSlWKUkO2
# 89TMsUh5RGfcpRqIW9OXGZEp4e0bgpLyMuMR6Nv4hl7PJmbI51BftW84RlQthKdu
# MT9ZfREBdQYKNhCOqod/VA==
