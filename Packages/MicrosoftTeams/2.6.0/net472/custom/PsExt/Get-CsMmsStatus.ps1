    ...
    process {
        try {
            if($PSBoundParameters.ContainsKey('SummaryOnly')) 
            {
                ...
                Microsoft.Teams.ConfigAPI.Cmdlets.internal\Get-CsMeetingMigrationStatusSummaryModern -Identity $Identity -StartTime $StartTime -EndTime $EndTime -State $state -MigrationType $MigrationType
            }
            else 
            {
                Microsoft.Teams.ConfigAPI.Cmdlets.internal\Get-CsMeetingMigrationStatusModern -Identity $Identity -StartTime $StartTime -EndTime $EndTime -State $state -MigrationType $MigrationType
            }
        } 
        catch 
        {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBfwBZmA6BzZ1QO
# 7RSell1fpDPig5RXELdV8VO+y9rO1qCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHOSriNA7I6e0zZqsXYlxEzx3LFp
# kog00tIB9wTvirHFMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAITMAdXo
# 5KWuwaMWXfwOcyoHV3a48nvW/4ISKWZUt6rrdKPDhAVVr4zSkT9zinR1i6y/kXTB
# 1WXewW6thPOty1dmOklUWwrSMWzHQdBt7UvCY/BTvsmI16E/0uYwJ2mUSFcEX7w4
# 4j+qQA+Sl0qUGGqRqJZo9BDstziOOjO4RXDOvukqrvlisL6DtKjEnn/3MrJK7aoV
# Sx+omGhgvR/QR8YqaSpOzmddRESP4Yihu42YEP3K7EvhinDflwDPprF4T7qzMdtL
# NSWWecJnhMX8Dk5/f4SQb430KMNt3RgncL5SlE7FJCgjzzo08GS6t16+AgibaPWv
# a7/Ux93DGiHRnVOhghLhMIIS3QYKKwYBBAGCNwMDATGCEs0wghLJBgkqhkiG9w0B
# BwKgghK6MIIStgIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUQYLKoZIhvcNAQkQAQSg
# ggFABIIBPDCCATgCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgnXDD
# pmS/XrVkO40A9xyrjHWCrxYPPk1QyfQlKcr4yp4CBmFDqV+dvxgTMjAyMTA5MzAx
# NjMzMDIuNzE0WjAEgAIB9KCB0KSBzTCByjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# LwYJKoZIhvcNAQkEMSIEIG7O7jVKZywggm8B+TZxsiCToidfFAZCEdnSDNzvYA+j
...
# k6NluzVbgkLT9hlGqjANBgkqhkiG9w0BAQsFAASCAQC6UI8Yru3ZCO8kcNeRJeXG
# AQNAx/MwqZLqbnD7O/b7EY2JmOLBImUr/EBZeUhGsHrm+rMp6EVo71A6SkR9j/OO
# f6k9D0HOmRbVX5dLQW8Ceh3YR8RaRyTs3mfIUw0brWpMvBZQoRUrdU7fJDoc0A1V
# 4dGDtBAYp2xDF2EAs1J7ixFuQJc8fIrCLV2JSsrOCZLyxfPI6tUmGlzpYMs0Zb3s
# Rd6V+lh3yj56dIhFgDcvlp8M2x0OS/ogvkRW+Kkm/eOs+f5lrNx/LZd/B1V9NDcI
# FA3X5pf7SJsZ3KN31NtNhnmVTjY/y9E7i5j+iUxgmA8hWKrSj26hrbdYNh39HyUX
