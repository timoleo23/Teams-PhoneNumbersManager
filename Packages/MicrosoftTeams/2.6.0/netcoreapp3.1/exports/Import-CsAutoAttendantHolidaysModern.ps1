...
.Link
https://docs.microsoft.com/en-us/powershell/module/teams/import-csautoattendantholidaysmodern
#>
...
param(
    ...
    [Parameter()]
    [Microsoft.Teams.ConfigAPI.Cmdlets.Generated.Category('Query')]
    [Microsoft.Teams.ConfigAPI.Cmdlets.Generated.Runtime.Info(PossibleTypes=([System.Byte[]]))]
    [System.Byte[]]
    # .
...
begin {
    try {
        ...
        $mapping = @{
            Import = 'Microsoft.Teams.ConfigAPI.Cmdlets.private\Import-CsAutoAttendantHolidaysModern_Import';
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDs6dTuQOn9JQXM
# gbu8Lr0qcj7lO45FkNbmFR7Yhzz53KCCDXMwggXxMIID2aADAgECAhMzAAACGYwK
...
# CisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIPbJ1EzCE1y3MP7R4sXnS4yXb61D
# hldAXOYLxl3Ft3kdMDoGCisGAQQBgjcCAQwxLDAqoAyACgBTAGsAeQBwAGWhGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBAAMZzFQQ
# yaR5xpccypNV8l9lJu9ElV2Oeuq6ct8jXOpc4wisjRmDLJn6JoX9pWn3en+hTuZ0
# jT3k+2gGx4f9IBhH5wyTIUTwmKapTTs1Mj+o79tSZ0ZlPJ/hdj/IsOcpJPRuspWr
# 3T8TyCdONAkQo7/csuR/HxFFoaqWHLr566STICUMI7Q6ZyrGrwiE/gvE/FhMJ9xP
# wN6q87Tg0aFNhBnFC/OXwjIzKL4rseVgQc2t7mvz+lbIAWoPMGZZRclEk3nA0GiO
# +YNfZ6VcyvTr+9WqLUBKGSUep6Kj4Y22jBKorB5K8XfDzPSKV7fdWsRcNs3gYiGy
# PXCSKP3RSZioPnOhghLhMIIS3QYKKwYBBAGCNwMDATGCEs0wghLJBgkqhkiG9w0B
# BwKgghK6MIIStgIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBUQYLKoZIhvcNAQkQAQSg
# ggFABIIBPDCCATgCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQg86LS
# fquoHjPeaDQ2U7PMTZKMM0XRomakp7NR2gkTKaUCBmFDqV+c3xgTMjAyMTA5MzAx
# NjMyNTkuNTA4WjAEgAIB9KCB0KSBzTCByjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# LwYJKoZIhvcNAQkEMSIEIG3qF785DRcSGmFsg9cJ8tQreXvvL/vuWeQ8TsrmInAu
...
# k6NluzVbgkLT9hlGqjANBgkqhkiG9w0BAQsFAASCAQBxg2CWTpDOFYk7BRTxOdUh
# 9ULsjtK6E5dnoXVlze0rnHcRVPwQ2gt7HcbcKSXQDqSXVaSuz8ZZVXVoUci0nLEK
# FSg83v0ocwUjvTA37wFZX7NQgpg5Jt+m1LDHp4SbocTQJtOQCwckvDYbDJhzIpZE
# 2x0tZk8vMcFUPR5BeE5TIhUyLuADScz/QFs3mYkltKHC4ciUePU4VDb/aAXWNQwQ
# ff3hCgae9RfNLRBOptuoU7ykfrK2JdD4+F+QMki4LNc8ig/Umc0quwgTU2d6jtBk
# E2CHaqn00LjjtXj0hfSYBYgD/DsSTPhe/B/PZo9Ydd/4UAYheoPWE4jKtGYCDGHY
